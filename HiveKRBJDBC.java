...
public class HiveKRBJDBC {
 public static void main(String[] args) throws Exception {
  ...
  System.out.println("\nExecuting statement: drop table if exists " + tableName);
  stmt.execute("drop table if exists " + tableName);
  System.out.println("\nExecuting statement: create table " + tableName + " (key int, value string)");
  ...
  sql = "insert into " + tableName + " values (1, 'Name1'), (2, 'Name2')";
  System.out.println("\nRunning: " + sql);
  stmt.execute(sql);
  // select * query
